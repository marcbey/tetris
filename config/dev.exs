...
config :tetris, TetrisWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:tetris, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:tetris, ~w(--watch)]}
  ]
...
config :tetris, TetrisWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/tetris_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
