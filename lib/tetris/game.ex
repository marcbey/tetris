defmodule Tetris.Game do
  ...
  def move(game, move_fn) do
    ...
    moved = Tetromino.maybe_move(new, old, valid)
    %{game | tetro: moved} |> show
  end

  def left(game), do: game |> move(&Tetromino.right/1) |> show
  ...
  def new_tetromino(game) do
    %{game | tetro: Tetromino.new_random()} |> show
  end
